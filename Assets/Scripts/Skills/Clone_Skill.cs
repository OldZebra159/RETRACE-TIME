...
public class Clone_Skill : Skill
{
    ...
    protected override void Start()
    {
        ...
        cloneAttackUnlockButton.OnUnlocked += UnlockCloneAttack;
        aggresiveCloneUnlockButton.OnUnlocked += UnlockAggresiveClone;
        multipleUnlockButton.OnUnlocked += UnlockMultiClone;
