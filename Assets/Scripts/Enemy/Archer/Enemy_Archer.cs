...
public class Enemy_Archer : Enemy
{
    ...
    public float safeDistance; // 在battleState中达到这个距离时Jump
    ...
    public ArcherBattelState battleState { get; private set; }
    ...
    protected override void Awake()
    {
        ...
        battleState = new ArcherBattelState(this, stateMachine, "Idle", this);
    ...
    public override void AnimationSpecialAttackTrigger()
    {
        ...
        newArrow.GetComponent<Arrow_Controller>().SetupArrow(arrowSpeed * facingDir, stats,facingDir);
    }
